...
// It returns the user's information.
  async function getUserInfo() {
    ...
    setIsUser(obtainData.roles.some(role => role.name === 'user'));
    return obtainData
  };
    ...
    <div>
      <nav id="navbar" onClick={toggleNavbar} className={navbarOpen ? 'open' : ''}>
        <ul className="navbar-items flexbox-col">
          ...
          {isAdmin ? (
            <li className="navbar-item flexbox-left">
              <Link to="/new_course" className="navbar-item-inner flexbox-left">
                <div className="navbar-item-inner-icon-wrapper flexbox">
                  <svg name="add-circle-outline" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-journal-plus" viewBox="0 0 16 16">
